...
from PyQt5.QtWidgets import (QAction, QApplication, QFileDialog, QMainWindow,
    QMdiArea, QMessageBox, QTextEdit, QWidget, QTableWidget, QTableWidgetItem)
from PyQt5.QtSql import QSqlQuery

import mdi_rc
from hris01 import hrisdb
...
class MainWindow(QMainWindow, object):
  ...
  def createMenus(self):
    ...
    query.prepare("select * from usermenu where username= ? and rights='VIEW'")
    query.addBindValue("WI")
    query.exec_()
